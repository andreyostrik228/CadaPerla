...
/**
 * Aviso permanente. La web es un trabajo de clase y varios horarios no están
 * confirmados, así que hay que decirlo donde se vea, no en letra pequeña.
 */
    ...
    <div className="border-b border-line bg-accent/15">
      <div className="mx-auto flex max-w-5xl gap-3 px-4 py-3">
        ...
        <p className="text-base text-foreground">
          <strong className="font-semibold">Esto es un trabajo de clase, no un servicio oficial.</strong>{" "}
          Los sitios que aparecen son reales, pero la mayoría de los horarios no están confirmados:{" "}
          <strong className="font-semibold">llama antes de ir.</strong> Si necesitas ayuda ahora,
          llama al{" "}
